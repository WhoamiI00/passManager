                                    ...
                                    return <tr key={index}>
                                        ...
                                        <td className='text-center w-20 py-2 px-0 border border-white'>
                                            <span className='cursor-pointer' onClick={() => editPassword(item.id)}>
                                                <lord-icon style={{ width: "25px", height: "25px", paddingTop: "8px", paddingLeft: "5px", cursor: "pointer" }} src="https://cdn.lordicon.com/jpdtnwas.json" trigger="hover"></lord-icon>
                                            </span>
                                            <span className='cursor-pointer' onClick={() => deletePassword(item.id)}>
                                                <lord-icon style={{ width: "25px", height: "25px", paddingTop: "8px", paddingLeft: "5px", cursor: "pointer" }} src="https://cdn.lordicon.com/jmkrnisz.json" trigger="hover"></lord-icon>
                                            </span>
                                        </td>
                                    </tr>
                                })}
